...
public class SolrCore extends EngineAbstract implements IEngine {
    ...
    public SolrCore(String baseurl, String coreName, int commitWithin, int commitEach, int optimizeEach, Logger logger, String requestHandler, boolean solrUseJavaBin) throws MalformedURLException {
    	
    	if (StringUtils.isNotEmpty(baseurl) && StringUtils.endsWith(baseurl, "/"))
