...
public abstract class GenericNormalizer {
    ...
    /*
    public static java.lang.String normalize(char ch)
    {
       int carVal = ch;
       if( carVal >= MIN && carVal <= MAX )
       {  // Remplacement
          return (java.lang.String)map.get(carVal - MIN);
       }
       return Character.toString(ch);
   }
   */
    
    public static java.lang.Character normalize(char ch)
    {
       int carVal = ch;
       if( carVal >= MIN && carVal <= MAX )
       {  // Remplacement
          return ((java.lang.String)map.get(carVal - MIN)).charAt(0);
       }
       return ch;
   }
}
