...
class Theme extends ThemeBase implements iTheme {
	...
	function generateHtmlStart() {
		...
		$res .= '<link rel="stylesheet" type="text/css" href="themes/taligentia/optimize/style.css" media="screen" />';
		$res .= '<link rel="stylesheet" type="text/css" href="themes/taligentia/styles.css" media="screen" />';
		$res .= '<link rel="stylesheet" type="text/css" href="themes/menu.css" media="screen" />';
		$res .= '<link rel="stylesheet" type="text/css" media="all" href="themes/taligentia/optimize/css/effects.css" />';
		...
		$res .= '<link rel="stylesheet" type="text/css" media="all" href="themes/taligentia/optimize/css/ie6.css" />';
		$res .= '<![endif]-->	';
	
		$res .= '<!--[if IE 7]>';
		$res .= '<link rel="stylesheet" type="text/css" media="all" href="themes/taligentia/optimize/css/ie7.css" />';
		$res .= '<![endif]-->';
	
		$res .= '<link rel="canonical" href="http://manager.mysolrserver.com/" /> ';
//		$res .= '<link href="themes/taligentia/optimize/styles/grey.css" rel="stylesheet" type="text/css" /> ';
		$res .= '<style type="text/css"> ';
//		$res .= '#logo img { display:none; }';
		$res .= '#logo .site-title, #logo .site-description { display:block; } ';
		$res .= '</style> ';
		$res .= '<link href="themes/taligentia/optimize/custom.css" rel="stylesheet" type="text/css" /> ';
	...
	function generateTop($page) {
		...
		$res .= '        <div id="header_logo"><img src="themes/taligentia/images/logo_small.jpg"></div>';
